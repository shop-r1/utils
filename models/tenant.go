...
type Tenant struct {
	...
	Domain1        string    `gorm:"type:varchar(255);unique" description:"租户独立域名1" json:"domain"`
	Domain2        string    `gorm:"type:varchar(255);unique" description:"租户独立域名2" json:"domain"`
