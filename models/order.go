...
type Order struct {
	...
	ActivityId       string               `sql:"type:char(20);index" description:"参与的活动ID" json:"activity_id"`
	ActivityName     string               `sql:"type:varchar(100)" description:"参与的活动名称" json:"activity_name"`
}
